...
class PaymentWebhookHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        # Optional protection. If PAYMENT_WEBHOOK_SECRET is configured,
        # callers must provide X-Webhook-Secret. Leave it empty for the
        # SMSGate dashboard webhook, which does not add this custom header.
