...
def admin_keyboard():
    return ReplyKeyboardMarkup([
        [KeyboardButton("📦 Product Management"), KeyboardButton("💳 Payment Management")],
        [KeyboardButton("💰 Pending Deposits")],
        [KeyboardButton("📢 Force Join"), KeyboardButton("📢 Broadcast")],
        [KeyboardButton("🗄️ Database")],
        [KeyboardButton("👥 User Management"), KeyboardButton("📞 Support Management")],
        [KeyboardButton("🔙 Return")],
    ], resize_keyboard=True)
